...
public:
  ...
  update_internal_mapping_ret update_internal_mapping(
    ...
    paddr_t old_addr,
    paddr_t new_addr,
    internal_node_t::base_ref new_node)
  {
...
private:
  ...
  void may_link_parent_child(iterator &ret, depth_t d, Transaction &t) {
    ...
    ceph_assert(child->touched_by == t.get_trans_id());
    ...
    if (parent->is_pending()) {
      ...
      ceph_assert(t.get_trans_id() == parent->touched_by);
  ...
  static get_internal_node_ret get_internal_node(
    ...
    node_key_t begin,
    node_key_t end,
    std::optional<typename iterator::node_position_t<internal_node_t>> parent_pos)
  {
