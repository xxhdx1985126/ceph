...
struct last_reclaimed_t {
  segment_seq_t reclaim_seq = NULL_SEG_SEQ; // used in AsyncCleaner::mount,
                                            // to decide the order of various
                                            // "reclaimed_to" recorded in
                                            // segment tails and ALLOC_TAIL
                                            // journal records
  journal_seq_t reclaimed_to = JOURNAL_SEQ_NULL; // used in Cache::replay_delta,
                                                 // to decide whether an alloc_blk
                                                 // should be replayed
