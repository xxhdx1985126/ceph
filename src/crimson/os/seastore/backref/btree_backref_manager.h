...
public:
  ...
  std::set<
    backref_buf_entry_t,
    backref_buf_entry_t::cmp_t> get_cached_backrefs_in_range(
    paddr_t start,
    paddr_t end) final;

  std::set<
    backref_buf_entry_t,
    backref_buf_entry_t::cmp_t> get_cached_backref_removals_in_range(
    paddr_t start,
    paddr_t end) final;
  ...
  std::set<
    ...
    Cache::backref_extent_buf_entry_t::cmp_t>
